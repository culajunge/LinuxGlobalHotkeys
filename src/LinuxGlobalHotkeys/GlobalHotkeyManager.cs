            ...
            while (!cancellationToken.IsCancellationRequested)
            {
                ...
                foreach (var shortcut in shortcuts.Keys)
                {
                    ...
                    if (isModifierPressed && isKeyPressed && !shortcutStates[shortcut])
                    {
                        ...
                        Console.WriteLine($"Shortcut triggered: {shortcut.ModifierName}+{shortcut.KeyName.ToUpper()}");
                    }
                    ...
                    else if ((!isModifierPressed || !isKeyPressed) && shortcutStates[shortcut])
                    {
                        ...
                        Console.WriteLine($"Shortcut released: {shortcut.ModifierName}+{shortcut.KeyName.ToUpper()}");
                    }
                }
